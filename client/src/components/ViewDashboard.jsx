...
const ViewDashboard = ({ items }) => {
  ...
  return (
    <div className="container mx-auto  w-[500px] p-4 mt-5 rounded-lg bg-white/30 backdrop-blur-md">
      ...
      {selectedRole && (
        <div>
          ...
          {Object.keys(items[selectedRole]).map((date) => (
            <div key={date} className="mb-4">
              ...
              <table className="min-w-full bg-white border border-gray-300">
                ...
                <tbody>
                  {items [selectedRole][date].map((entry, index) => (
